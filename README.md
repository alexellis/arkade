...
| [doggo](https://github.com/mr-karan/doggo)                                   | Command-line DNS client for humans. Features include DoH, DoT, DoQ support.                                                                                       |
...
| [fq](https://github.com/wader/fq)                                            | jq for binary formats - tool, language and decoders for working with binary data.                                                                                 |
...
| [jless](https://github.com/PaulJuliusMartinez/jless)                         | A command-line JSON viewer designed for reading, exploring, and searching through JSON data.                                                                      |
...
| [lf](https://github.com/gokcehan/lf)                                         | Terminal file manager with vim-like bindings.                                                                                                                     |
...
| [mcfly](https://github.com/cantino/mcfly)                                    | Fly through your shell history with context-aware suggestions.                                                                                                    |
...
| [pueue](https://github.com/Nukesor/pueue)                                    | Manage your shell commands as a task queue.                                                                                                                       |
...
| [tldr](https://github.com/tealdeer-rs/tealdeer)                              | A very fast implementation of tldr in Rust.                                                                                                                       |
...
| [trufflehog](https://github.com/trufflesecurity/trufflehog)                  | Find and verify credentials in code repositories.                                                                                                                 |
...
There are 203 tools, use `arkade get NAME` to download one.                                                                                                                                                                                         

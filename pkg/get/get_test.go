...
func Test_GetDownloadURLs(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			tool := toolList[0]
			got, _, err := tool.GetURL(tc.os, tc.arch, tool.Version, false)
			if err != nil {
				t.Fatal(err)
			}
...
func Test_DownloadKubectx(t *testing.T) {
	...
	got, _, err := tool.GetURL("linux", arch64bit, "v0.9.4", false)
	if err != nil {
		t.Fatal(err)
	}
...
func Test_Copacetic(t *testing.T) {
	...
	t.Run(test.os+" "+test.arch+" "+test.version, func(r *testing.T) {
		got, _, err := tool.GetURL(test.os, test.arch, test.version, false)
		if err != nil {
			t.Fatal(err)
		}
		if got != test.url {
	...
	tests := []test{
		{
			...
			arch:    arch64bit,
			version: toolVersion,
			url:     "https://github.com/loft-sh/devpod/releases/download/v0.7.0-alpha.34/devpod-windows-amd64.exe",
		},
		{
			os:      "darwin",
			arch:    arch64bit,
			version: toolVersion,
			url:     "https://github.com/loft-sh/devpod/releases/download/v0.7.0-alpha.34/devpod-darwin-amd64",
		},
		{
			os:      "darwin",
			arch:    archDarwinARM64,
			version: toolVersion,
			url:     "https://github.com/loft-sh/devpod/releases/download/v0.7.0-alpha.34/devpod-darwin-arm64",
		},
		{
			os:      "linux",
			arch:    arch64bit,
			version: toolVersion,
			url:     "https://github.com/loft-sh/devpod/releases/download/v0.7.0-alpha.34/devpod-linux-amd64",
		},
		{
			os:      "linux",
			arch:    archARM64,
			version: toolVersion,
			url:     "https://github.com/loft-sh/devpod/releases/download/v0.7.0-alpha.34/devpod-linux-arm64",
		},
	}
	...
	tests := []test{
		{
			...
			arch:    arch64bit,
			version: toolVersion,
			url:     "https://github.com/homeport/dyff/releases/download/v1.10.2/dyff_1.10.2_darwin_amd64.tar.gz",
		},
		{
			os:      "darwin",
			arch:    archDarwinARM64,
			version: toolVersion,
			url:     "https://github.com/homeport/dyff/releases/download/v1.10.2/dyff_1.10.2_darwin_arm64.tar.gz",
		},
		{
			os:      "linux",
			arch:    arch64bit,
			version: toolVersion,
			url:     "https://github.com/homeport/dyff/releases/download/v1.10.2/dyff_1.10.2_linux_amd64.tar.gz",
		},
		{
			os:      "linux",
			arch:    archARM64,
			version: toolVersion,
			url:     "https://github.com/homeport/dyff/releases/download/v1.10.2/dyff_1.10.2_linux_arm64.tar.gz",
		},
		{
			os:      "mingw64_nt-10.0-18362",
			arch:    arch64bit,
	...
	tests := []test{
		{
			...
			arch:    arch64bit,
			version: toolVersion,
			url:     "https://storage.googleapis.com/claude-code-dist-86c565f3-f756-42ad-8dfa-d59b1c096819/claude-code-releases/2.1.12/darwin-x64/claude",
		},
		{
			os:      "darwin",
			arch:    archDarwinARM64,
			version: toolVersion,
			url:     "https://storage.googleapis.com/claude-code-dist-86c565f3-f756-42ad-8dfa-d59b1c096819/claude-code-releases/2.1.12/darwin-arm64/claude",
		},
		{
			os:      "linux",
			arch:    arch64bit,
			version: toolVersion,
			url:     "https://storage.googleapis.com/claude-code-dist-86c565f3-f756-42ad-8dfa-d59b1c096819/claude-code-releases/2.1.12/linux-x64/claude",
		},
		{
			os:      "linux",
			arch:    archARM64,
		...
		},
		{
			...
			arch:    arch64bit,
			version: toolVersion,
			url:     "https://storage.googleapis.com/claude-code-dist-86c565f3-f756-42ad-8dfa-d59b1c096819/claude-code-releases/2.1.12/windows-x64/claude",
		},
	}

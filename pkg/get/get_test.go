...
func Test_DownloadCiliumCLI(t *testing.T) {
	tools := MakeTools()
	name := "cilium"
	...
	tests := []test{
		{
			...
			arch:    arch64bit,
			version: toolVersion,
			url:     `https://github.com/cilium/cilium-cli/releases/download/v1.6/cilium-linux-amd64.tar.gz`,
		},
		{
			os:      "darwin",
			arch:    arch64bit,
			version: toolVersion,
			url:     `https://github.com/cilium/cilium-cli/releases/download/v1.6/cilium-darwin-amd64.tar.gz`,
		},
		{
			os:      "linux",
			arch:    archARM64,
			version: toolVersion,
			url:     `https://github.com/cilium/cilium-cli/releases/download/v1.6/cilium-linux-arm64.tar.gz`,
		},
		{
			os:      "darwin",
			arch:    archDarwinARM64,
			version: toolVersion,
			url:     `https://github.com/cilium/cilium-cli/releases/download/v1.6/cilium-darwin-arm64.tar.gz`,
		},
		{
			os:      "ming",
			arch:    arch64bit,
			version: toolVersion,
			url:     `https://github.com/cilium/cilium-cli/releases/download/v1.6/cilium-windows-amd64.tar.gz`,
		},
	}

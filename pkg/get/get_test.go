...
func Test_DownloadNorouter(t *testing.T) {
	tools := MakeTools()
	name := "norouter"
	...
	tests := []test{
		{os: "mingw64_nt-10.0-18362",
			arch:    arch64bit,
			version: "v0.6.4",
			url:     "https://github.com/norouter/norouter/releases/download/v0.6.4/norouter-Windows-x64.zip"},
		{os: "linux",
			arch:    arch64bit,
			version: "v0.6.4",
			url:     "https://github.com/norouter/norouter/releases/download/v0.6.4/norouter-Linux-x86_64.tgz"},
		{os: "darwin",
			arch:    arch64bit,
			version: "v0.6.4",
			url:     "https://github.com/norouter/norouter/releases/download/v0.6.4/norouter-Darwin-x86_64.tgz"},
		{os: "darwin",
			arch:    "aarch64",
			version: "v0.6.4",
			url:     "https://github.com/norouter/norouter/releases/download/v0.6.4/norouter-Darwin-arm64.tgz"},
		{os: "linux",
			arch:    "aarch64",
			version: "v0.6.4",
			url:     "https://github.com/norouter/norouter/releases/download/v0.6.4/norouter-Linux-aarch64.tgz"},
	}
	for _, tc := range tests {
		got, err := tool.GetURL(tc.os, tc.arch, tc.version)
		if err != nil {
